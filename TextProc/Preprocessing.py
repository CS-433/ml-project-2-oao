...
if __name__ == '__main__':
    ...
    print(Preprocessing(config_1).preprocess_string('Preprocess a string using the preprocessing configuration config_1'))
    
    # Example 2
    # Description: Here we can see the preprocessing configuration config_1
    print(Preprocessing(config_1).preprocess_string('Here we can see the preprocessing configuration config_1'))